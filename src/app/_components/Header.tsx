...
export default function Header() {
  ...
  const title = selectedLanguage?.title ? selectedLanguage.title : "Name the Var";
  ...
  return (
    <div className="mx-auto flex w-full max-w-screen-md select-none items-center justify-between py-4">
      <div className="relative">
          <Link
            href="/"
            className="text-2xl font-semibold text-neutral-700 underline decoration-red-400 decoration-2 whitespace-nowrap"
          >
            {title}
          </Link>

          <div
            className="absolute right-full top-1/2 mr-1.5 mt-px hidden -translate-y-1/2 whitespace-nowrap text-lg text-neutral-400/70 lg:block"
          >
            {prefix}
          </div>

          <div
            className="absolute left-full top-1/2 ml-1.5 mt-px hidden -translate-y-1/2 whitespace-nowrap text-lg text-neutral-400/70 lg:block"
          >
            {suffix}
          </div>
      </div>
